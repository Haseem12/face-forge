        ...
        <style>{`
          ...
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .ff-input {
            ...
            background: #f9fafb; padding: 0 16px 0 42px; font-size: 14px;
            font-family: 'Nunito', sans-serif; font-weight: 500; color: #111111; outline: none;
            transition: border-color 0.2s, box-shadow 0.2s, background 0.2s;
          }
          .ff-input::placeholder { color: #b5bbc6; }
          .ff-input:focus { border-color: #f97316; background: #ffffff; box-shadow: 0 0 0 3px rgba(249,115,22,0.1); }
          ...
          .ff-btn-submit {
            ...
            border: none; border-radius: 14px; cursor: pointer; letter-spacing: 0.3px; margin-top: 4px;
            transition: opacity 0.2s, transform 0.1s;
          }
          .ff-btn-submit:hover:not(:disabled) { opacity: 0.9; transform: translateY(-1px); }
          ...
          .ff-footer a { color: #f97316; text-decoration: none; font-weight: 800; transition: opacity 0.15s; }
        ...
        <div className="ff-root">
          <div className="ff-container">
            ...
            <div className="ff-welcome">
              ...
              <p className="ff-welcome-sub">enter your email to get started</p>
            </div>

            <form className="ff-form" onSubmit={handleSendCode}>
